...
public class MainActivity extends AppCompatActivity {
    ...
    String sentID= null, location = "", currentLat = "", currentLong = "";
    ...
    public void getCityLocation(){
        ...
        try {
            List<Address> addresses = gcd.getFromLocation(Double.parseDouble(currentLat), Double.parseDouble(currentLong), 1);
            if (addresses.size() > 0) {
