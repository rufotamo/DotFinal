    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            if(user.isEmailVerified()) {
                findViewById(R.id.verify_email_button);
                btn = (Button) findViewById(R.id.verify_email_button);
                btn.setText("Main Page");
...
//            findViewById(R.id.verify_email_button).setEnabled(!user.isEmailVerified());
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.newUser_button) {
            ...
            if(btn.getText().toString().equalsIgnoreCase(getString(R.string.verify_email)))
